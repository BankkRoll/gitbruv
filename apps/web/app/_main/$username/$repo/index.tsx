...
import { useRepoPageData, useRepoReadme, useRepoCommits } from "@/lib/hooks/use-repositories";
  ...
  return (
    <div className="flex items-center">
      <Button
        variant="secondary"
        size="sm"
        className="h-7 px-2.5 rounded-l-md rounded-r-none border-r-0 text-xs font-semibold bg-secondary hover:bg-muted border border-border shadow-sm flex items-center gap-2"
      >
      ...
      <Button
        variant="secondary"
        size="sm"
        className="h-7 px-1.5 rounded-r-md rounded-l-none bg-secondary hover:bg-muted border border-border shadow-sm border-l"
      >
    ...
    <div className="container px-4 py-6">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <SplitActionButton icon={GitFork} label="Fork" count={475} />
          <SplitActionButton icon={Star} label="Starred" count={475} />
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        <div className="lg:col-span-9 space-y-4">
          ...
          <div className="border border-border rounded-md overflow-hidden bg-background shadow-sm">
            <div className="flex items-center justify-between px-4 py-3 bg-secondary/50 border-b border-border">
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground shrink-0 ml-4">
                ...
                <div className="flex items-center gap-1.5 font-bold text-foreground cursor-pointer hover:text-accent">
          ...
          {readmeOid && (
            <div className="border border-border rounded-md overflow-hidden mt-6 bg-background shadow-sm">
              <div className="flex items-center gap-2 px-4 py-3 bg-background border-b border-border sticky top-0 z-10">
        ...
        <aside className="lg:col-span-3 space-y-6 pt-2">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center gap-2 text-[14px] text-foreground hover:text-accent cursor-pointer group">
                ...
                <span className="group-hover:underline">
                  <span className="font-bold">475</span> stars
                </span>
              </div>
              <div className="flex items-center gap-2 text-[14px] text-foreground hover:text-accent cursor-pointer group">
                <GitFork className="h-4 w-4 shrink-0 text-muted-foreground" />
                <span className="group-hover:underline">
                  <span className="font-bold">21</span> forks
                </span>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3 pt-4 border-t border-border">
            ...
            <Link to="#" className="text-sm font-semibold text-accent hover:underline block">
